...
from loaders.create_training_dataset_depth import get_training_dataset
from trainer_depth import BaseTrainer
...
def train(args):
    ...
    out_dir = os.path.join(args.save_dir, 'depth_{}_full'.format(seq_name))
    ...
    log_dir = 'logs/depth_{}_4'.format( seq_name)
