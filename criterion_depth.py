...
def compute_depth_loss(x2s_depth, zoe_depth, num_pts):
    '''
    the depth of mapped 3d locations should aproximate to actual depth
    '''
    loss = F.l1_loss(x2s_depth, zoe_depth, reduction='none').sum()
    return 1/num_pts *loss

def compute_point_loss(px2s_proj, px2s, num_pts):
    '''
    the depth of mapped 3d locations should aproximate to actual depth
    '''
    loss = F.l1_loss(px2s_proj, px2s, reduction='none').sum()
    return 1/num_pts *loss
